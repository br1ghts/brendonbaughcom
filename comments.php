...
if (! function_exists('brendon_core_comment')) {
	...
	function brendon_core_comment($comment, $args, $depth) {
		...
		echo '<li id="comment-' . esc_attr($comment->comment_ID) . '" class="comment rounded-2xl border border-[#F2A25C]/30 bg-white p-6 shadow-sm transition hover:border-[#F2A25C]/60 focus-within:border-[#F2A25C]/60">';
...
<div id="comments" class="comments-area space-y-6">
	...
	$shared_field_classes = 'w-full rounded-lg border border-[#F2A25C]/30 bg-white px-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-[#F2A25C] focus:ring-2 focus:ring-[#F2A25C]/40';
	...
	<div class="rounded-2xl border border-[#F2A25C]/30 bg-white p-6 shadow-sm">
